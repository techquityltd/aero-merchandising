...
{{--<script src="{{ mix('js/manifest.js', 'modules/aerocommerce/admin') }}"></script>--}}
{{--<script src="{{ mix('js/vendor.js', 'modules/aerocommerce/admin') }}"></script>--}}
{{--<script src="{{ mix('js/app.js', 'modules/aerocommerce/admin') }}"></script>--}}
@stack('scripts')
</body>
</html>
